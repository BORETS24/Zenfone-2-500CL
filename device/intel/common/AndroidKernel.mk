...
ifeq ($(ASUS_BUILD_PROJECT), ze500cl)
        ifeq ($(TARGET_BUILD_VARIANT), user)
            KERNEL_DIFFCONFIG += $(TARGET_DEVICE_DIR)/ze500cl_user_defconfig
        else ifeq ($(TARGET_BUILD_VARIANT), userdebug)
            KERNEL_DIFFCONFIG += $(TARGET_DEVICE_DIR)/ze500cl_userdebug_defconfig
        else
            KERNEL_DIFFCONFIG += $(TARGET_DEVICE_DIR)/ze500cl_userdebug_defconfig
        endif
endif
...
ifeq ($(ASUS_BUILD_PROJECT), me372cl)
